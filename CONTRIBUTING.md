...
- [Ask a question](https://github.com/maiHydrogen/SortAid/issues)
- [Submit a bug report](https://github.com/maiHydrogen/SortAid/issues)
- [Request a new feature](https://github.com/maiHydrogen/SortAid/issues/new/choose)
- [Suggest ways to improve the developer experience of an existing feature](https://github.com/maiHydrogen/SortAid/issues/new/choose)
- Add documentation
...
You can find all existing issues [here](https://github.com/maiHydrogen/SortAid/issues). 
...
**Step 3** - Fork the [`maiHydrogen/SortAid`](https://github.com/maiHydrogen/SortAid) repo to your account.  
...
**Step 1** - Open an [issue](https://github.com/maiHydrogen/SortAid/issues/new/choose) so that we can discuss on the new feature.  
**Step 2** - Fork the [`maiHydrogen/SortAid`](https://github.com/maiHydrogen/SortAid) repo to your account.  
